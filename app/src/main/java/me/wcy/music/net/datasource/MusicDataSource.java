...
public final class MusicDataSource implements DataSource {
        ...
        public Factory(Context context) {
            this(
                    ...
                    new DefaultHttpDataSource.Factory()
                            .setUserAgent(NeteaseHeaders.INSTANCE.getUserAgent())
    ...
    public long open(DataSpec dataSpec) throws IOException {
        ...
        if (Util.isLocalFileUri(dataSpec.uri)) {
            ...
            java.io.File cachedSong = MusicCacheManager.INSTANCE.getCachedSongFile(dataSpec.uri);
            if (cachedSong != null) {
                dataSource = getFileDataSource();
                DataSpec cachedDataSpec = dataSpec.buildUpon()
                        .setUri(Uri.fromFile(cachedSong))
                        .build();
                return dataSource.open(cachedDataSpec);
            }
